...
enum _expr_kind {BoolOp_kind=1, Y_ExcMishandle_kind=2, NamedExpr_kind=3,
...
expr_ty _Py_BoolOp(boolop_ty op, asdl_seq * values, int lineno, int col_offset,
                   int end_lineno, int end_col_offset, PyArena *arena);
#define Y_ExcMishandle(a0, a1, a2, a3, a4, a5, a6) _Py_Y_ExcMishandle(a0, a1, a2, a3, a4, a5, a6)
expr_ty _Py_Y_ExcMishandle(expr_ty try_body, expr_ty except_body, int lineno,
                           int col_offset, int end_lineno, int end_col_offset,
                           PyArena *arena);
